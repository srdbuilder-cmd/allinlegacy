...
export default function DefaultsTab({ plan, setters, onReset }) {
  ...
  return (
    <div className="space-y-6">
      <Card className="bg-slate-50">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <button
            type="button"
            onClick={onReset}
            className="px-4 py-2 rounded-lg border border-rose-300 text-rose-700 font-semibold bg-white hover:bg-rose-50 whitespace-nowrap"
          >
            Reset to defaults
          </button>
        </div>
      ...
      <Card>
        <SectionTitle color="text-purple-700">Facility care costs</SectionTitle>
      ...
      <Card>
        <SectionTitle color="text-blue-700">In-home care</SectionTitle>
        ...
        <h3 className="font-semibold text-slate-800 mb-2">Weekly hours by year</h3>
      ...
      <Card>
        <SectionTitle>Rental assumptions</SectionTitle>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <Card>
        <SectionTitle>Transaction defaults</SectionTitle>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <NumberInput
